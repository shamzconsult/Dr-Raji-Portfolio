        ...
        <div className="container relative z-10 px-4 mx-auto md:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="relative w-full md:w-auto">
              ...
              <div className="relative h-[350px] w-[350px] md:h-[450px] md:w-[450px] overflow-hidden rounded-full border-2 border-gold-400/30 bg-navy-900/50 p-2 mx-auto">
                <Image
      ...
      <footer className="py-6 md:py-8 border-t border-navy-800/40">
        <div className="container px-4 mx-auto md:px-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-sm text-white/60 hover:text-gold-400 transition-colors">
                Privacy Policy
              </a>
              <a href="#" className="text-sm text-white/60 hover:text-gold-400 transition-colors">
                Terms of Service
